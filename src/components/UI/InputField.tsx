...
const InputFieldAdornment = styled(InputAdornment)(({ theme, position, onClick }) => ({
        ...
        <InputFieldBase
            {...(adornment && {
                ...(adornment.position === "start" && {
                    startAdornment: (
                        <InputFieldAdornment position="start" {...(adornment.onClick && { onClick: adornment.onClick })}>
                            {adornment.icon}
                        </InputFieldAdornment>
                    ),
                }),
                ...(adornment.position === "end" && {
                    endAdornment: (
                        <InputFieldAdornment position="end" {...(adornment.onClick && { onClick: adornment.onClick })}>
                            {adornment.icon}
                        </InputFieldAdornment>
                    ),
                }),
